        ...
        <div class="container-fluid">
          ...
          <div class="row text-center mt-4">
            ...
            <div class="card ml-3 mb-3" style="width: 16rem;">
              <img class="card-img-top" src="<?php echo base_url('assets/uploads/img/'.$brg->gambar) ?>" alt="Card image cap">
              <div class="card-body">
                <h5 class="card-title mb-1"><?php echo $brg->nama_barang ?></h5>
                <small><?php echo $brg->keterangan ?></small><br>
                <span class="badge badge-primary mb-2">Rp <?php echo number_format($brg->harga, 0, ',', '.') ?></span><br>
                ...
                <?php echo anchor('dashboard/detail/'.$brg->id_barang,'<div class="btn btn-primary"> Detail</div>') ?>
              </div>
            </div>
