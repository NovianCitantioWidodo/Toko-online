<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo site_url('admin/data_barang') ?>">
          <i style="color: white" class="fas fa-fw fa-cubes"></i>
          <span>Data Barang</span></a>
      </li>
      
      <li class="nav-item">
        <a class="nav-link" href="<?php echo site_url('admin/invoice') ?>">
        <i style="color: white" class="fas fa-fw fa-file-invoice"></i>
          <span>Invoice</span></a>
      </li>
